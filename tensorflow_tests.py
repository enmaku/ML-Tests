...
with tf.Session() as sess:
    ...
    starting_accuracy = float(accuracy.eval(feed_dict={x: mnist.test.images, y_: mnist.test.labels, keep_prob: 1.0}))
    ...
    for i in range(20000):
        ...
        if i % 1000 == 0 and i > 0:
            ...
            current_accuracy = float(accuracy.eval(feed_dict={x: mnist.test.images, y_: mnist.test.labels, keep_prob: 1.0}))
    ...
    ending_accuracy = float(accuracy.eval(feed_dict={x: mnist.test.images, y_: mnist.test.labels, keep_prob: 1.0}))
